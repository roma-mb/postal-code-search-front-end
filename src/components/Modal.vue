...
<template>
  <div v-if="isOpen" class="fixed z-10 inset-0 overflow-y-auto" id="modal">
    ...
    >
      ...
      >
        <div>
          <div class="mx-auto flex items-center justify-center h-15 w-15">
            <svg
        ...
        <div class="sm:mt-3 lg:mt-5">
          <button
            class="inline-flex justify-center w-full rounded-md border border-transparent shadow-sm px-4 py-2 bg-error-r text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:text-xl"
