...
<template>
  <div class="h-full">
    <!--Main-->
    <div
      class="container pt-24 md:pt-32 px-4 mx-auto flex flex-wrap flex-col md:flex-row items-cente"
    >
      <!--Left Col-->
      <div
      ...
      >
        ...
        >
          <div class="mb-4">
            <label class="block text-courier-y py-2 font-bold mb-2">
              {{
                isCreateAccount
                  ? "Signup search postal code"
                  : "Create Your Account."
              }}.
            </label>
          ...
          >
            ...
            <div>
              <span class="font-medium">Unauthorized!</span> Check your e-mail,
              password and try again.
            </div>
          </div>
          <div class="flex items-center pt-4">
            <button
              class="mr-2 bg-gradient-to-r from-courier-y to-courier-yf hover:from-gray-500 hover:to-gray-800 text-white font-bold py-2 px-4 rounded focus:ring transform transition hover:scale-105 duration-300 ease-in-out"
              type="submit"
              @click="login"
            ...
            <button
              class="ml-2 bg-gradient-to-r from-courier-b to-courier-b hover:from-gray-500 hover:to-gray-800 text-white font-bold py-2 px-4 rounded focus:ring transform transition hover:scale-105 duration-300 ease-in-out"
              @click="createAccount"
              type="submit"
              v-if="isCreateAccount"
            >
